...
@if($user->image)
    <img src="{{ asset('uploads/vendor/'.$user->image) }}" class="w-100 border-radius-lg shadow-sm" alt="user1">    
@else
    <img src="{{ asset('uploads/vendor/default-img.jpg') }}" class="w-100 border-radius-lg shadow-sm" alt="user1">    
@endif
</span>
</div>
</div>
...
<div class="input-group">
<input id="password" name="password" class="form-control" type="password" onfocus="focused(this)" onfocusout="defocused(this)">
</div>
</div>
