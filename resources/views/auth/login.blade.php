                                ...
                                <div class="card-body">
                                    <form role="form" method="POST" action="{{ route('login.post') }}">
                                        ...
                                        <div class="flex flex-col mb-3">
                                            ...
                                            @if ($errors->has('email')) <p class="text-danger text-xs pt-1"> {{ $errors->first('email') }}</p>@endif
                                        </div>
                                        <div class="flex flex-col mb-3">
                                            <input type="password" name="password" class="form-control form-control-lg" aria-label="Password"  placeholder="password">
                                            @if ($errors->has('password')) <p class="text-danger text-xs pt-1"> {{ $errors->first('password') }}</p>@endif
                                        </div>
